...
<body style="background: url('images/services/restau3.jpg') ; color:#D9D9F3;>
	...
	while ($row=mysql_fetch_array($res_sql)){
		echo "<tr>";
            echo "<td>".$row['codRestaurante']."</td>";
			echo "<td>".(utf8_encode($row['nombreRestau']))."</td>";
			echo "<td id='borrar'><a href='borrarrestaurante.php?id=".$row['codRestaurante']."'>Borrar</a></td>";
			echo "<td id='actualizar'><a href='actualizar-restaurantes.php?id=".$row['codRestaurante']."'>Actualizar</a></td>";
		echo "</tr>";
	}
echo "</table";
