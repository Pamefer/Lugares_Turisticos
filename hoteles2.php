       ...
       <div class="container">
            ...
            <div class="row">
                ...
                <li> <?php
                     extract($_POST);
                     include("conect.php");
                    echo "<form id='checkboxes' method='POST'  action='bushoteles2.php?user=$user''>";
                             ?>
            ...
            <li>
                <br> <a href="busHoteles2.php"><input  value="BUSCAR" name="enviar" class="btn btn-primary"  type="submit"/></a>
             </li>
